import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{h as t,n}from"./createLucideIcon-BUWcaZa-.js";import{r,t as i}from"./AdminDataTable-qK5oBRZL.js";import{t as a}from"./award-DpDrXk3D.js";import{t as o}from"./file-text-e6ryriXo.js";import{Zt as s,bn as c}from"./index-CG_jjvHF.js";import{i as l,l as u,n as d,t as f}from"./AdminUi-CKOh-eg3.js";var p=e(t(),1);function m(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function h(e){let t=[[`Student Name`,e.student_name],[`Roll Number`,e.roll_number||`—`],[`Class`,e.class_name||`—`],[`Exam`,e.exam_name||`—`],[`Subject`,e.subject||`—`],[`Exam Date`,e.exam_date||`—`],[`Academic Year`,e.academic_year||`—`],[`Marks Obtained`,`${e.marks_obtained??`—`} / ${e.max_marks??`—`}`],[`Percentage`,`${e.percentage??`—`}%`],[`Grade`,e.grade||`—`],[`Result`,(e.result_status||`—`).toUpperCase()]];return`
