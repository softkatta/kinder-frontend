import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{h as t,n}from"./createLucideIcon-BUWcaZa-.js";import{l as r}from"./services-SSgFpg7u.js";import{r as i,t as a}from"./AdminDataTable-TWFOpn9s.js";import{t as o}from"./award-DpDrXk3D.js";import{t as s}from"./file-text-e6ryriXo.js";import{Gt as c}from"./index-D7WF3EB5.js";import{i as l,l as u,n as d,t as f}from"./AdminUi-gvButokR.js";var p=e(t(),1);function m(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function h(e){let t=[[`Student Name`,e.student_name],[`Roll Number`,e.roll_number||`—`],[`Class`,e.class_name||`—`],[`Exam`,e.exam_name||`—`],[`Subject`,e.subject||`—`],[`Exam Date`,e.exam_date||`—`],[`Academic Year`,e.academic_year||`—`],[`Marks Obtained`,`${e.marks_obtained??`—`} / ${e.max_marks??`—`}`],[`Percentage`,`${e.percentage??`—`}%`],[`Grade`,e.grade||`—`],[`Result`,(e.result_status||`—`).toUpperCase()]];return`
